  ...
  render() {
    ...
    return (
      <div id="left1-bottom-right">
        <div id="left1-bottom-right-inner1">
          <div id="left1-bottom-right-inner2">
            <div>
              <div id="left1-bottom-right-inner3">
                <span id="heart" className={this.props.hearted ? "j-fill-heart" : "j-empty-heart"} onClick={this.handleClick}>
...
/* function UnclickedHeart(props) {
  return (
    <div>
      <span id="heart" className={props.hearted ? "hide-heart" : "show-heart"} onClick={props.handleClick}>
...
function ClickedHeart(props) {
  return (
    <div>
      <span id="clicked-heart" className={props.hearted ? "show-heart" : "hide-heart"} onClick={props.handleClick}>
