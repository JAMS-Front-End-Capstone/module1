...
app.get('/api/attraction/:attractionId', (req, res) => {
  console.log(`${req.method} request received for ${req.url}:${req.params.id}`);
  db.findModel(req.params.id).then((attraction) => {
